...
function Header() {
    ...
    return <Box w='100%' p='20px' display='flex' alignItems='center' justifyContent='space-between' border='1px' borderBottomColor='facebook.500'>
        <Box boxSizing="border-box" fontSize='3xl'>
